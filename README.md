...
[![Latest Stable Version](https://img.shields.io/packagist/v/prismaticoder/laravel-prompt-manager)](https://packagist.org/packages/prismaticoder/laravel-prompt-manager)
[![Total Downloads](https://img.shields.io/packagist/dt/prismaticoder/laravel-prompt-manager)](https://packagist.org/packages/prismaticoder/laravel-prompt-manager)
[![License](https://img.shields.io/github/license/prismaticoder/laravel-prompt-manager)](LICENSE)
